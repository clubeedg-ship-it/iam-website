...
const routes = {
  ...
  '/blog': '/blog.html',
  '/about': '/over-ons.html',
  '/pricing': '/prijzen.html',
  '/education': '/onderwijs.html',
  '/healthcare': '/zorg-revalidatie.html',
  '/entertainment': '/parken-speelhallen.html',
  '/build-a-park': '/bouw-een-park.html',
  '/3d-games': '/3d-spellen.html',
  '/create-your-game': '/maak-je-spel.html',
  '/partner': '/word-partner.html',
  '/privacy': '/privacybeleid.html',
  '/cookies': '/cookiebeleid.html',
  '/accessibility': '/toegankelijkheid.html',
  '/products/2-in-1-floor-wall': '/products/2-in-1-vloer-muur.html',
  ...
  '/products/mobile-floor': '/products/mobiele-vloer.html',
  '/products/software': '/products/software-maatwerk.html',
  '/products/interactive-drawings': '/products/interactieve-tekeningen.html',
};
